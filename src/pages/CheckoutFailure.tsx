        ...
        <div className="container-custom max-w-3xl">
          <div className="p-8 rounded-lg shadow-sm text-center" style={{ backgroundColor: theme.background }}>
            <div className="mx-auto w-16 h-16 mb-6 rounded-full flex items-center justify-center" style={{ backgroundColor: theme.accent }}>
              <XCircle size={32} style={{ color: '#e11d48' }} />
            </div>
            <h1 className="font-playfair text-3xl mb-4" style={{ color: theme.foreground }}>Transaction Failed</h1>
            <p className="mb-6" style={{ color: theme.mutedForeground }}>
              Sorry, your payment could not be processed.<br />You will be redirected to the home page shortly.
            </p>
            <div className="mb-6">
              <h2 className="text-lg font-semibold mb-2" style={{ color: theme.foreground }}>Your Cart</h2>
